      ...
      <div className="bg-white p-8 rounded shadow-md w-[400px]">
        ...
        {step === 2 && (
          <form onSubmit={handleVerifySubmit} className="flex flex-col items-center">
            ...
            {/* The Input is readOnly so they MUST use the virtual keyboard */}
            <input 
              type="text" 
              placeholder="••••••" 
              value={otpCode} 
              readOnly 
              className="w-full border p-3 mb-4 rounded text-center tracking-[0.5em] text-2xl font-mono bg-gray-50 outline-none focus:ring-2 focus:ring-blue-500"
            />
            
            {/* The Secure Virtual Keyboard */}
            <VirtualKeyboard 
            ...
            <button type="submit" className="w-full bg-green-600 text-white p-3 mt-6 rounded hover:bg-green-700 font-semibold transition-colors">
